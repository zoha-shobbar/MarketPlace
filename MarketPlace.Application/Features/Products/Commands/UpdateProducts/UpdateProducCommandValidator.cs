...
namespace MarketPlace.Application.Features.Products.Commands.UpdateProducts
{
    public class UpdateProducCommandValidator : AbstractValidator<UpdateProducCommand>
    {
        ...
        private async Task<bool> IsSpecialPriceLessThanMainPrice(UpdateProducCommand updateProducCommand, CancellationToken cancellationToken)
        {
        ...
        private async Task<bool> IsSerialNumberUnique(UpdateProducCommand updateProducCommand, CancellationToken cancellationToken)
        {
