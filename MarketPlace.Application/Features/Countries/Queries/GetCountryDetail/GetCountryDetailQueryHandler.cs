...
{
    public class GetCountryDetailQueryHandler : IRequestHandler<GetEventDetailQuery, CountryDetailViewModel>
    {
        ...
        public GetCountryDetailQueryHandler(IMapper mapper, IAsyncRepository<Country> eventRepository, 
                                                            IAsyncRepository<Currency> currencyRepository,
                                                            IAsyncRepository<Language> languageRepository )
        {
            _mapper = mapper;
            _countryRepository = eventRepository;
            _currencyRepository = currencyRepository;
        }

        public async Task<CountryDetailViewModel> Handle(GetEventDetailQuery request, CancellationToken cancellationToken)
        {
