...
using MarketPlace.Application.Features.PageAndPosts.Commands.UpdatePageAndPost;

namespace MarketPlace.Application.Features.PageAndPosts.Commands.CreatePageAndPost
{
    public class CreatePageAndPostCommandValidator : AbstractValidator<CreatePageAndPostCommand>
    {
        public CreatePageAndPostCommandValidator()
        {
            RuleFor(p => p.Title)
